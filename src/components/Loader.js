function Loader() {
  return (
    <div className="cont max-w-7xl w-[90%] mx-auto  py-4">
      <p className=" text-Very-Dark-Blue1 dark:text-white text-xl flex items-center gap-1 z-50">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="32"
          height="32"
          className="animate-spin dark:fill-white fill-black"
          viewBox="0 0 256 256"
        >
